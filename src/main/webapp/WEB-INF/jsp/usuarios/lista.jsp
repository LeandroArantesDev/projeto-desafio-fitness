                ...
                <table>
                    ...
                    <c:forEach var="usuario" items="${usuarios}">
                        <tr>
                            ...
                            <td>${usuario.nome}</td>
                            <td>${usuario.email}</td>
                            <td><span class="role-tag role-tag--${usuario.tipo}">${usuario.tipo}</span></td>
                            <td>
                                <div class="links">
                                    <a class="btn btn-secondary btn-table" href="${pageContext.request.contextPath}/usuarios?acao=editar&id=${usuario.id}">Editar</a>
                                    <a class="btn btn-danger btn-table" href="${pageContext.request.contextPath}/usuarios?acao=excluir&id=${usuario.id}"
