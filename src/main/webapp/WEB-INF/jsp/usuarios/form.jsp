            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="tipo" name="tipo" required>
                        <option value="user" <c:if test="${usuario.tipo == 'user' or empty usuario.tipo}">selected</c:if>>Usuario</option>
                        <option value="admin" <c:if test="${usuario.tipo == 'admin'}">selected</c:if>>Administrador</option>
                    </select>
                </div>
            </div>
