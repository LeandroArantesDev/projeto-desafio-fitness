...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/desafios-lista.css">
</head>
<body>
    <header class="topbar">
      <div class="container">
                ...
                <table>
                    ...
                    <c:forEach var="desafio" items="${desafiosParticipando}">
                        <tr>
                            ...
                            <td><strong>${desafio.metaTotal}</strong> <span class="unit">${desafio.unidadeMedida}</span></td>
                            <td>${fn:substring(desafio.dataInicio, 8, 10)}/${fn:substring(desafio.dataInicio, 5, 7)}/${fn:substring(desafio.dataInicio, 0, 4)} a ${fn:substring(desafio.dataFim, 8, 10)}/${fn:substring(desafio.dataFim, 5, 7)}/${fn:substring(desafio.dataFim, 0, 4)}</td>
                            <td><span class="status-tag status-tag--${desafio.status}">${desafio.status}</span></td>
                            <td>
                                <div class="links">
                                    <a class="btn btn-secondary btn-table" href="${pageContext.request.contextPath}/progresso?desafioId=${desafio.id}">Registrar progresso</a>
                                </div>
                            </td>
                        </tr>
                    </c:forEach>
                ...
                <table>
                    ...
                    <c:forEach var="desafio" items="${desafiosCriados}">
                        <tr>
                            ...
                            <td>
                                <div class="links">
                                    <a class="btn btn-secondary btn-table" href="${pageContext.request.contextPath}/desafios?acao=editar&id=${desafio.id}">Editar</a>
                                    <a class="btn btn-danger btn-table" href="${pageContext.request.contextPath}/desafios?acao=excluir&id=${desafio.id}"
